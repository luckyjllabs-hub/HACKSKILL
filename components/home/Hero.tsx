    ...
    <div>
      ...
      <section className="py-16 md:py-24 px-4 sm:px-8 md:px-16 max-w-[1280px] mx-auto flex flex-col lg:flex-row items-center gap-12">
        ...
        <div className="flex-1 w-full relative max-w-xl lg:max-w-none">
          <div className="absolute inset-0 bg-surface-container-highest rounded-[3rem] transform -rotate-3 z-0"></div>
          <div className="relative z-10 w-full rounded-xl bg-white border border-outline-variant shadow-[0_20px_50px_rgba(0,0,0,0.06)] p-6 sm:p-8 space-y-6">
      ...
      <section className="py-12 bg-surface-container-lowest border-y border-outline-variant">
        <div className="max-w-[1280px] mx-auto px-4 sm:px-8 md:px-16">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            ...
            <div className="text-center md:text-left space-y-2">
              <p className="text-4xl md:text-5xl font-bold text-primary">120+</p>
              <p className="text-xs font-semibold text-secondary uppercase tracking-wider">Projects</p>
            </div>
            <div className="text-center md:text-left space-y-2">
              <p className="text-4xl md:text-5xl font-bold text-primary">90%</p>
              <p className="text-xs font-semibold text-secondary uppercase tracking-wider">Match Success</p>
            </div>
            <div className="text-center md:text-left space-y-2">
              <p className="text-4xl md:text-5xl font-bold text-primary">25+</p>
      ...
      <section id="features-section" className="py-20 px-4 sm:px-8 md:px-16 max-w-[1280px] mx-auto space-y-12">
        <div className="text-center max-w-2xl mx-auto space-y-4">
          <h2 className="text-3xl md:text-4xl font-semibold text-primary">How AI connects you</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="md:col-span-2 bg-surface-container-lowest border border-outline-variant rounded-xl p-8 shadow-[0_20px_50px_rgba(0,0,0,0.02)] flex flex-col justify-between min-h-[300px]">
            <div className="space-y-4">
            ...
            <div className="mt-8 h-32 bg-surface-container rounded-lg border border-outline-variant flex items-center justify-center text-xs text-secondary font-mono">
              [ Semantic Skill Graph • Computer Vision ↔ ML ↔ Full Stack ↔ Domain ]
            </div>
          </div>

          {/* Small Card 1: Availability Sync */}
          <div className="bg-surface-container-lowest border border-outline-variant rounded-xl p-8 shadow-[0_20px_50px_rgba(0,0,0,0.02)] flex flex-col justify-between">
            <div className="space-y-4">
          ...
          <div className="md:col-span-2 bg-primary text-on-primary border border-outline-variant rounded-xl p-8 shadow-[0_20px_50px_rgba(0,0,0,0.05)] flex flex-col md:flex-row items-center justify-between gap-8">
            ...
            <button
              onClick={onScrollToForm}
              className="bg-surface text-on-surface font-semibold text-sm px-6 py-3.5 rounded-full hover:bg-surface-container transition-colors whitespace-nowrap"
            >
              Start Matching Now
            </button>
          </div>
